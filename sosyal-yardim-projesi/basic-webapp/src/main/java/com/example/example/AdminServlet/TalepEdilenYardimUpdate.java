...
public class TalepEdilenYardimUpdate extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String TalepIdParam = request.getParameter("talepId");
        if (TalepIdParam != null) {
            int talepId = Integer.parseInt(TalepIdParam);
            String talepAdi = request.getParameter("YardimTipAd");
...
// İşlemleri gerçekleştirin
                ...
                TalepYardimTip talep = session.get(TalepYardimTip.class, talepId);

                // Update the fields with new values
                talep.setTalepYardimAdi(talepAdi);
