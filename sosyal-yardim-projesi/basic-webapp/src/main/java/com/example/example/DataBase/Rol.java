...
public class Rol {
    ...
    public static int RolGrupSayiAl() {
        ...
        session.beginTransaction();
            ...
            Query query = session.createQuery("SELECT Count (DISTINCT r.rolGrup) FROM  Rol r WHERE r.rolGrup IS NOT NULL");
            int result = ((Long) query.uniqueResult()).intValue();
            System.out.println("roldaki rsult: "+ result);
