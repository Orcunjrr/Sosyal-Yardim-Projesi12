...
@WebServlet(name = "yardimkararilisteleme" , value = "/adminpanel/yardimkararilisteleme")
public class yardimkararilisteleme extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("yardimKararList", results);

        request.getRequestDispatcher("yardimkararlist.jsp").forward(request, response);
    }
