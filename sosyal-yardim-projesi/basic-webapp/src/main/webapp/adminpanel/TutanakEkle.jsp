          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <div class="card-body bg-transparent border-bottom button-container row justify-content-around">
                <button class="btn btn-secondary col-md-2"> <a href="ailelist.jsp?Id=<%=info.getIdInfoId()%>" class="text-white p-4" >Aile Yakınlıkları</a></button>
                <button class="btn btn-secondary col-md-2">KPS Aile Yakınlıkları</button>
                <button class="btn btn-secondary col-md-2"><a href="aynievdeoturanlarlist.jsp?Id=<%=info.getIdInfoId()%>" class="text-white p-4" >Aynı Evde Oturanlar</a></button>
                ...
                <button class="btn btn-secondary col-md-2"><a href="Askerhükümlügiris.jsp?Id=<%=info.getIdInfoId()%>" class="text-white p-4" >Asker/Hükümlü Girişi</a></button>
              </div>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
...
<%--                    </div>--%>
              ...
              <div class="card card-secondary">
                <div class="card-header"><label class="required">Talep Edilen Yardım Türü</label> </div>
                <div class="card-body">
                  <div class="row">
                    <% int columnCount = 4;
