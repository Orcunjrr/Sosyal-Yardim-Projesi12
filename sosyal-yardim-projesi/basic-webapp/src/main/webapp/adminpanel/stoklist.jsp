        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb ">
              ...
              <li class="breadcrumb-item active">Stok Listele</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title bg-secondary">Stok Listele</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
                        ...
                        <div class="table-responsive" style="overflow-x: auto;">
                          <table id="example2" class="table table-bordered table-hover" style="width: 100%; table-layout: fixed;">
                            ...
                            <tr>
                              ...
                              <td><%= s.getStokKod()%></td>
                              <td><%= s.getGuncelMiktar()%></td>
                              <td><%= s.getGuncelFiyat()%></td>
                              <td><%= s.getStokTanim()%></td>
                            </tr>
                            <% } %>
                            </tbody>
                            <%}%>
