...
YonlendirilenAltKurum altkurum = YonlendirilenAltKurum.getbySubID(ID);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-10">
            <h1>Yönlendiren Alt Kurum Düzenle</h1>
            <ol class="breadcrumb ">
              <li class="breadcrumb-item"><a href="#">Anasayfa</a></li>
              <li class="breadcrumb-item"><a href="#">Yönetici İşlemleri</a></li>
              <li class="breadcrumb-item"><a href="#">Yönlendiren Kurum Girişleri</a></li>
              <li class="breadcrumb-item"><a href="#">Yönlendiren Alt Kurum</a></li>
              <li class="breadcrumb-item active">Yönlendiren Alt Kurum Düzenle</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">
                  Yönlendiren Alt Kurum Düzenle
                </h3>
              </div>
              <!-- /.card-header -->

              <!-- form başlangıcı -->
              <form role="form" method="post" action="YonlendirmeAltKurumUpdate">
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="durum">
                          <% for (YonlendirilenKurum k : kurum) { %>
                          <option value="<%= k.getYonlendirilenKurumID() %>" <%= altkurum.getYonlendirilenKurum().getYonlendirilenKurumID() == k.getYonlendirilenKurumID() ? "selected" : "" %> ><%= k.getYonlendirilenKurumName() %></option>
                          <% } %>
                        </select>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Yönlendirilen Alt Kurum Adı</label>
                        <input type="hidden" class="form-control" name="YonlendirenAltKurumid" value="<%= altkurum.getYonlendirilenAltKurumID() %>" required>
                        <input type="text" class="form-control" name="YonlendirenAltKurumAd" value="<%= altkurum.getYonlendirilenAltKurumName() %>" required>
                      </div><!-- text input -->
                    </div>
                  </div>
                </div>
