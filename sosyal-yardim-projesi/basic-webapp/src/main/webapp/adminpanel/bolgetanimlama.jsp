                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label class="required">Bölge Adı</label>
                        <select name="BolgeId" class="form-control">
                          <%for(Bolge bolge : zone){%>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <select name="MahId" class="form-control required" multiple="">
