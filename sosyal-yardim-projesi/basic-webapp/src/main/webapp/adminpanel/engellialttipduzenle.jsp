...
<%@ page import="com.example.example.DataBase.EngelliAlt" %>
<%@ page import="java.util.List" %>
<%
  HttpSession userSession = request.getSession();
  if(!Rol.hasRole(userSession,"Role_EngelliAltTip_Düzenle")){
    response.sendRedirect("../Error/Error.html");
  }
List<Engelli> disabled = Engelli.getAll();


String id = request.getParameter("ID");
int ID = Integer.parseInt(id);
EngelliAlt engellisub = EngelliAlt.getbySubID(ID);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8">
            <h1>Engelli Alt Tipi Düzenle</h1>
            <ol class="breadcrumb ">
              ...
              <li class="breadcrumb-item"><a href="#">Engelli Alt Tipi Tanımlama</a></li>
              <li class="breadcrumb-item active">Engelli Alt Tipi Düzenle</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">
                  Engelli Alt Tipi Düzenle
                </h3>
              </div>
              <!-- /.card-header -->

              <!-- form başlangıcı -->
              <form role="form" action="disabledSubUpdate" method="post">
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label class="required">Engelli Alt Tip Adı</label>
                        <input type="hidden" class="form-control" name="disabledsubid" value="<%=engellisub.getDisabledSubID()%>">
                        <input type="text" class="form-control" value="<%= engellisub.getDisabledSubName() %>" name="disabledsubname" required>
                      </div><!-- text input -->
                    </div>
                  </div>
                </div>
