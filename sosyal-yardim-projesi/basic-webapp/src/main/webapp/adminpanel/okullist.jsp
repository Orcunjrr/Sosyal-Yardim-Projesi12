...
<%
 List<Okul> okul = Okul.getAllSchool();

HttpSession userSession = request.getSession();
String roleName = "Role_Okul_Listele";
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb ">
              ...
              <li class="breadcrumb-item active">Okul Listesi</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Okul Listele</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
...
<script>
  $(document).ready(function() {
    ...
    $('#confirmDeleteButton').on('click', function() {
      ...
      $.get("okulsil", {id:selectedId})
      window.location.href = "okulsil?Id=" + selectedId;
