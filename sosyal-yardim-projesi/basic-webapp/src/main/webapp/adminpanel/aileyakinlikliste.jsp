  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Aile Yakınlık Bilgi Listesi</h1>
            <ol class="breadcrumb ">
              <li class="breadcrumb-item"><a href="#">Anasayfa</a></li>
              <li class="breadcrumb-item"><a href="#">İşlemlerim</a></li>
              <li class="breadcrumb-item"><a href="#">Aile Yakınlık Bilgisi</a></li>
              <li class="breadcrumb-item active">Aile Yakınlık Bilgi Listesi</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <% } %>
              <!-- form start -->
              <form action="Aileyakinliklist" method="post">
                <div class="card-body">
                  <div class="form-group row m-2">
                    <label class="col-sm-3 col-form-label">Müracaat TC Kimlik Numarası</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" name="">
                    </div>
                    <label class="col-sm-2 col-form-label ml-2">Yakınlık</label>
                    <div class="col-sm-3">
                  ...
                  <div class="form-group row m-2">
                    ...
                    <label class="col-sm-2 col-form-label ml-2">Eş</label>
                    <div class="col-sm-3">
                  ...
                  <div class="form-group row m-2">
                    ...
                    <label class="col-sm-2 col-form-label ml-2">Meslek</label>
                    <div class="col-sm-3">
                      <select class="form-control" name="">
                        <option></option>
                      </select>
                  ...
                  <div class="form-group row m-2">
                    ...
                    <label class="col-sm-2 col-form-label ml-2">Eğitim Durumu</label>
                    <div class="col-sm-3">
                      <select class="form-control" name="">
                  ...
                  <div class="form-group row m-2">
                    <label class="col-sm-3 col-form-label">Medeni Hali</label>
                    <div class="col-sm-3">
                      <select class="form-control" name="medeniHal">
                        <option>Lütfen Seçiniz</option>
                        <option>Evli</option>
                        <option>Bekar</option>
                        <option>Dul</option>
                  ...
                  <div class="form-group row m-2">
                    ...
                    <label class="col-sm-2 col-form-label ml-2">Son Tutanak Mı?</label>
                    <div class="col-sm-3">
                      <select class="form-control" name="">
                        <option>Lütfen Seçiniz</option>
                        <option>Evet</option>
                  ...
                  <div class="row justify-content-center mt-2 pt-2"> <!-- Butonu alt satırda ortalamak için d-flex ve justify-content-center sınıflarını kullanıyoruz -->
                  ...
                  <div class="col-12">
                        <div class="table-responsive" style="overflow-x: auto;">
                          <table id="example2" class="table table-bordered table-hover" style="width: 100%; table-layout: fixed;">
                            <% List<AileYakinliklari> Aileyakinliklist = (List<AileYakinliklari>) request.getAttribute("Aileyakinliklist");
                              if (Aileyakinliklist == null || Aileyakinliklist.isEmpty()) { %>
                                <h3 class="fw-bolder fs-2qx pb-5 pb-md-10" style="color: red;">
                            ...
                            <tbody>
                            <% for (AileYakinliklari aileYakinliklari : Aileyakinliklist) { %>
                            <tr>
                              <td>
