...
<%
  ...
  List<EngelliAlt> disabledsub = EngelliAlt.getAllDisabledSub();

  List<Personel> users = Personel.getAllUserInfo();
  HttpSession userSession = request.getSession();
String roleName = "Role_EngelliAltTip_Ekle";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Engelli Alt Tip Tanımlama</h1>
            <ol class="breadcrumb ">
              ...
              <li class="breadcrumb-item active">Engelli Alt Tip Tanımlama</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-secondary">
              ...
              <form role="form" method="post" action="disabledSubType">
                <div class="card-body">
                  ...
                  <div class="form-group row m-2">
                    <label class="col-sm-2 col-form-label required">Engelli Alt Tip Adı</label>
                    <div class="col-sm-4">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Engelli Alt Tipi Listele</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
                  <div class="col-12">
                        <div class="table-responsive" style="overflow-x: auto;">
                          <table id="example2" class="table table-bordered table-hover" style="width: 100%; table-layout: fixed;">
                            ...
                            <tbody>
                            <tr>
                              <% for(EngelliAlt dissub : disabledsub){%>
                              <td>
                                ...
                                <i class="fa fa-times" style="font-size: 25px; color: red; cursor: pointer; vertical-align: middle;" onclick="confirmDelete()"></i>
                              </td>
