...
<%
  ...
  Muracaat muracat = Muracaat.getbyID(Id);
  KullaniciBilgi idinfo = muracat.getIdInfoId();
  Dilekce dilekce = muracat.getIdInfoId().getPetition();
  iletisim iletisim = muracat.getIdInfoId().getContact();
  KullaniciBilgi tcinfo = KullaniciBilgi.getbyID(idinfo.getIdInfoId());
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-3">
                          ...
                          <div class="form-group text-center">
                            ...
                            <input type="hidden" name="tcid" value="<%=adresno.getAddressID()%>">
                      ...
                      <div class="row">
                        <div class="col-sm-3">
                          <div class="form-group">
                            ...
                            <textarea class="form-control" rows="2" name="itdilekceKonu"><%= dilekce.getObjectionPetitionSubject()%></textarea>
                          </div>
                        </div>
                        <div class="col-sm-3">
                          <div class="form-group">
                            <label>İtiraz Dilekçe Sonuç</label>
                            <textarea class="form-control" rows="2" name="itdilekceSonuc"><%= dilekce.getObjectionPetitionResult()%></textarea>
                          </div>
                        </div>
                        <div class="col-sm-3">
                          <div class="form-group">
                            <label>Dilekçe Konu</label>
                            <textarea class="form-control" rows="2" name="dilekceKonu" ><%= dilekce.getPetitionSubject()%></textarea>
                          </div>
                        </div>
                        <div class="col-sm-3">
                          <div class="form-group">
                            <label>Dilekçe Sonuç</label>
                            <textarea class="form-control" rows="2" name="dilekceSonuc"><%= dilekce.getPetitionResult()%></textarea>
                          </div>
                        </div>
