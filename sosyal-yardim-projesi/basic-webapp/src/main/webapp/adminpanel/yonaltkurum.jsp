          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">
                  Yönlendirilen Kurum Tanımlama
                </h3>
              </div>
              <!-- /.card-header -->

              <!-- form start -->
              <form role="form" method="post" action="YonlendirenAltKurum">
                <div class="card-body">
                  <div class="form-group row m-2">
                    <label class="col-sm-3 col-form-label">Yönlendirilen Kurum Adı</label>
                    <div class="col-sm-4">
                      <select class="form-control" name="YonlendirenKurumId">
                        <% for (YonlendirilenKurum k : kurum){ %>
                        <option value="<%= k.getYonlendirilenKurumID()%>"><%=k.getYonlendirilenKurumName() %></option>
                        <%} %>
                      </select>
                    </div>
                  </div>
                  <div class="form-group row m-2">
                    <label class="col-sm-3 col-form-label required">Yönlendirilen Alt Kurum Adı</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" name="YonlendirenAltKurumName" required>
                    </div>
                  </div>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Yönlendirilen Alt Kurum Bilgileri</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
                        ...
                        <div class="table-responsive" style="overflow-x: auto;">
                          <table id="example2" class="table table-bordered table-hover" style="width: 100%; table-layout: fixed;">
                            ...
                            <tr>
                              ...
                              <th>Yönlendiren Alt Kurum</th>
                            </tr>
                            </thead>
                            <tbody>
                            <% for(YonlendirilenAltKurum ak : altkurum){ %>
                            <tr>
                              <td>
                              ...
                              <td><%= ak.getYonlendirilenAltKurumID()%></td>
                              <td><%= ak.getYonlendirilenAltKurumName() %></td>
