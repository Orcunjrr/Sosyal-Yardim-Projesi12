        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb ">
              ...
              <li class="breadcrumb-item"><a href="#">Bölge</a></li>
              <li class="breadcrumb-item active">Bölge Giriş</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <form action="saveBolge" method="post">
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label class="form-heading required">Bölge Kodu</label>
                    ...
                    <div class="col-sm-6">
                      <!-- text input -->
                      <div class="form-group">
                        <label class="form-heading required">Bölge Aktiflik Durumu</label>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label class="form-heading required">Bölge Adı</label>
