...
<%
  List<YardimTipi> Assistances = YardimTipi.getAll();
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb ">
              ...
              <li class="breadcrumb-item active">Yardım Tipi Tanımlama</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">
                  Genel Yardım Tipi Tanımlama
                </h3>
              </div>
              <!-- /.card-header -->

              <form action="yardimTipServlet" method="post">
                <div class="card-body">
                  <div class="form-group row m-2">
                    <label class="col-sm-2 col-form-label required">Yardım Tip Adı</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" name="yardimAd" required="true">
                    </div>
                  </div>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Yardım Tipi Listesi</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
                  <div class="col-12">
                        <div class="table-responsive" style="overflow-x: auto;">
                          <table id="example2" class="table table-bordered table-hover" style="width: 100%; table-layout: fixed;">
                            ...
                            <tbody>
                            <% for(YardimTipi yardim : Assistances){%>
                            <tr>
                              <td>
