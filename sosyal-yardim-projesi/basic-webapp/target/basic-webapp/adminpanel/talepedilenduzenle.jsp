  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-10">
            <h1>Talep Edilen Yardım Tipi Tanımlama Düzenle</h1>
            <ol class="breadcrumb ">
              ...
              <li class="breadcrumb-item"><a href="#">Talep Edilen Yardım Tipi Tanımlama</a></li>
              <li class="breadcrumb-item active">Talep Edilen Yardım Tipi Tanımlama Düzenle</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">
                  Talep Edilen Yardım Tipi Tanımlama Düzenle
                </h3>
              </div>
              <!-- /.card-header -->
