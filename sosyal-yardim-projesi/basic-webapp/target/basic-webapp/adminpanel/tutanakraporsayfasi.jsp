...
<%
  ...
  List<KullaniciBilgi> info = KullaniciBilgi.getAll();
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tutanak Raporu</h1>
            <ol class="breadcrumb ">
              <li class="breadcrumb-item"><a href="#">Anasayfa</a></li>
              <li class="breadcrumb-item"><a href="#">Raporlar</a></li>
              <li class="breadcrumb-item active">Tutanak Raporu</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">
                  Adres Tespit Tutanak Liste Kriterleri
                </h3>
              </div>
              <!-- /.card-header -->

              <!-- form start -->
              <form action="tutanakraporlistele" method="post">
                <div class="card-body">
                  <div class="form-group row m-2">
                    <label class="col-sm-2 col-form-label">Tespit No:</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" name="tespitno">
                    </div>

                    <label class="col-sm-2 col-form-label m-2">Sağlık Problemi Var Mı:</label>
                    <div class="col-sm-3">
                      <select class="form-control" name="SaglıkProblem">
                  ...
                  <div class="form-group row m-2">
                      ...
                      <div class="col-sm-3">
                        <input type="text" class="form-control" name="muracaatNo">
                      </div>

                    <label class="col-sm-2 col-form-label m-2">Ailede Engelli Var Mı:</label>
                    <div class="col-sm-3">
                      <select class="form-control" name="AileEngel">
                        <option>Lütfen Seçiniz</option>
                        <option>VAR</option>
                        <option>YOK</option>
                      </select>
                  ...
                  <div class="form-group row m-2">
                    ...
                    <div class="col-sm-3">
                      <input type="number" class="form-control" name="tcKimlik" required maxlength="11">
                    </div>

                    <label class="col-sm-2 col-form-label m-2">Sosyal Güvencesi:</label>
                    <div class="col-sm-3">
                      <select class="form-control" name="sosyalgüvencesi">
                        <option selected disabled>Lütfen Seçiniz</option>
                        <option>Bağkur</option>
                        <option>Emekli Sandığı</option>
                        <option>SGK</option>
                        <option>Yeşilkart</option>
                  ...
                  <div class="form-group row m-2">
                    <label class="col-sm-2 col-form-label required" >Adı-Soyadı:</label>
                    <div class="col-sm-1">
                    ...
                    <label class="col-sm-2 col-form-label m-2">Sosyal Güvencesi Var Mı:</label>
                    <div class="col-sm-3">
                      <select class="form-control" name="sosyalgüvencesi">
                        <option selected disabled>Lütfen Seçiniz</option>
                        <option>VAR</option>
                  ...
                  <div class="form-group row m-2">
                    <label class="col-sm-2 col-form-label ">Ev Durumu:</label>
                    <div class="col-sm-3">
                      <select class="form-control" name="EvDurum">
                        <option selected disabled>Lütfen Seçiniz</option>
                        <option>Ev Sahibi</option>
                        <option>Kira</option>
                      </select>
                    </div>
                    <label class="col-sm-2 col-form-label m-2 ">Adres No:</label>
                    <div class="col-sm-3">
                  ...
                  <div class="form-group row m-2">
                    <label class="col-sm-2 col-form-label ">Ev Tipi:</label>
                    <div class="col-sm-3">
                      <select class="form-control" name="AileEngel">
                        <option selected disabled>Lütfen Seçiniz</option>
                        <option>Daire</option>
                    ...
                    <label class="col-sm-2 col-form-label m-2">İlçe:</label>
                    <div class="col-sm-3">
                  ...
                  <div class="form-group row m-2">
                    <label class="col-sm-2 col-form-label ">Yakacak Tipi:</label>
                    <div class="col-sm-3">
                    ...
                    <label class="col-sm-2 col-form-label m-2">Mahalle:</label>
                    <div class="col-sm-3">
                  ...
                  <div class="form-group row m-2">
                    <label class="col-sm-2 col-form-label ">Yardım Alınan Kurumlar:</label>
                    <div class="col-sm-3">
                      <select class="form-control" name="YardimDurum">
                        <option>2022 yaşlılık(2022)</option>
                        <option>Kaymakamlık</option>
                        <option>Engelli Maaşı</option>
                        <option>İlçe Belediyesi</option>
                        <option>Diğer Özel Vakıflar</option>
                      </select>
                    </div>
                    <label class="col-sm-2 col-form-label m-2">Cadde/Sokak:</label>
                    <div class="col-sm-3">
                  ...
                  <div class="form-group row m-2">
                    ...
                    <label class="col-sm-2 col-form-label m-2">Eğitim Durumu:</label>
                      <div class="col-sm-3">
                        <select class="form-control" name="egitimDurum">
                          <option selected disabled>Lütfen Seçiniz</option>
                  ...
                  <div class="form-group row m-2">
                    <label class="col-sm-2 col-form-label ">Ailede Yaşayan Kişi Sayısı:</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" name="evtel">
                    </div>
                    <label class="col-sm-2 col-form-label m-2 ">Medeni Durumu:</label>
                      <div class="col-sm-3">
                  ...
                  <div class="form-group row m-2">
                    <label class="col-sm-2 col-form-label ">Eş Durumu:</label>
                    <div class="col-sm-3">
                      <select class="form-control" name="EsDurum">
                        <option selected disabled>Lütfen Seçiniz</option>
                        <option>Terk</option>
                    ...
                    <div class="form-group row m-2">
                      <label class="col-sm-3 col-form-label">Şehit Var mı?</label>
                      <div class="col-sm-3 col-form-label">
                        <div class="icheck-primary d-inline">
                          <input value="Var" type="radio" id="sehitevet" name="sehit" >
                          <label for="sehitevet">
                            Var
                          </label>
                        </div>
                        <label></label>
                        <div class="icheck-primary d-inline">
                          <input value="Yok" type="radio" id="sehithayir" name="sehit" >
                          <label for="sehithayir">
                            Yok
                          </label>
                        </div>
                      </div>
                      <label class="col-sm-3 col-form-label">Gazi Var Mı?</label>
                      <div class="col-sm-3 col-form-label">
                        <div class="icheck-primary d-inline">
                          <input value="Var" type="radio" id="gazievet" name="gazi">
                          <label for="gazievet">
                            Var
                          </label>
                        </div>
                        <label></label>
                        <div class="icheck-primary d-inline">
                          <input value="Yok" type="radio" id="gazihayir" name="gazi" >
                          <label for="gazihayir">
                            Yok
                          </label>
                        </div>
                  ...
                  <div class="form-group row m-2">
                    ...
                    <div class="col-sm-3">
                      <input type="number" class="form-control" name="arsivdosyano">
                    </div>

                    <div class="form-group row m-2">
                      <label class="col-sm-3 col-form-label">Asker Var mı?</label>
                      <div class="col-sm-3 col-form-label">
                        <div class="icheck-primary d-inline">
                          <input value="Var" type="radio" id="askerevet" name="asker">
                          <label for="askerevet">
                            Var
                          </label>
                        </div>
                        <label></label>
                        <div class="icheck-primary d-inline">
                          <input value="Yok" type="radio" id="askerhayir" name="asker">
                          <label for="askerhayir">
                            Yok
                          </label>
                        </div>
                      </div>
                      <label class="col-sm-3 col-form-label" id="nowrap">Son Tutanak Mı?</label>
                      <div class="col-sm-3 col-form-label">
                        <div class="icheck-primary d-inline">
                          <input value="Var" type="radio" id="sonevet" name="son">
                          <label for="sonevet">
                            Var
                          </label>
                        </div>
                        <label></label>
                        <div class="icheck-primary d-inline">
                          <input value="Yok" type="radio" id="sonhayir" name="son">
                          <label for="sonhayir">
                            Yok
                          </label>
                        </div>
                    ...
                    <div class="form-group row m-2">
                      <label class="col-sm-2 col-form-label">Talep Edilen Yardımlar:</label>
                      <div class="col-sm-3">
                        <select class="form-control" name=""  multiple="true" >
                          <option>Çocuk Bezi Yardımı</option>
                          <option>Doğal Afet Yardımı</option>
                          <option>Ekmek Yardımı</option>
                          <option>Ev Eşyası Yardımı</option>
                        </select>
                      </div>
                    </div>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Adres Tespit Tutanak Listesi</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
                  <div class="col-12">
                    <div class="table-responsive" style="overflow-x: auto;">
                      <table id="example2" class="table table-bordered table-hover" style="width: 100%; table-layout: fixed;">
                        <% List<Tutanak> tutanaklist = (List<Tutanak>) request.getAttribute("tutanakRaporList");
                          if (tutanaklist != null && !tutanaklist.isEmpty()) { %>
                        <colgroup>
                        ...
                        <tr>
                          ...
                          <th>Ev Tel</th>
                          <th>Cep Tel</th>
                          <th>Müracaat Durum</th>
                          <th>Yakacak Tipi</th>
                        </tr>
                        </thead>
                        <tbody>
                        <% for (Tutanak tutanakBilgi : tutanaklist) { %>
                        <tr>
                          <td>
                            <a href="MuracatListesic.jsp?Id=">
                              <i class="fa fa-eye" style="font-size: 20px; color:black; cursor: pointer; vertical-align: middle;"></i>
                            </a>
                          </td>
                          <td><%=tutanakBilgi.getId()%></td>
                          <td><%=tutanakBilgi.getKullaniciId().getApplication().getAppId()%></td>
                          <td><%=tutanakBilgi.getKullaniciId().getIdNo()%></td>
                          <td><%=tutanakBilgi.getKullaniciId().getAppliName()%></td>
                          <td><%=tutanakBilgi.getKullaniciId().getApplication().getArchiveFileNo()%></td>
                          <td><%=tutanakBilgi.getKullaniciId().getApplication().getApplicationDate()%></td>
                          <td><%=tutanakBilgi.getKullaniciId().getBirthDate()%></td>
                          <td><%=tutanakBilgi.getKullaniciId().getMaritalStatus()%></td>
                          <td><%=tutanakBilgi.getKullaniciId().getContact().getDistrict()%></td>
                          <td><%=tutanakBilgi.getKullaniciId().getContact().getNeighborhood()%></td>
                          <td><%=tutanakBilgi.getKullaniciId().getContact().getStreet()%></td>
                          <td><%=tutanakBilgi.getKullaniciId().getContact().getCellPhone()%></td>
                          <td><%=tutanakBilgi.getKullaniciId().getContact().getCellPhone()%></td>
                          <td><%=tutanakBilgi.getKullaniciId().getApplication().getStatus()%></td>
                          <td><%=tutanakBilgi.getYakacaktipi()%></td>
                        </tr>
                        <%}%>
                        </tbody>
                        <%}%>
