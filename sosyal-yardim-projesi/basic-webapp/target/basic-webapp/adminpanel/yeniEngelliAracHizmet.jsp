...
<%
  ...
  List<EngelliAracHizmet> engelliAracHizmets = EngelliAracHizmet.getAll();
  List<EngelliGiris> engelli = EngelliGiris.getAll();
%>
...
<div class="wrapper">
  ...
  <!-- general form elements -->
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <%for(EngelliGiris e: engelli) {

                if(e.getKullanici().getApplication().getAppId()==info.getApplication().getAppId()){%>
              <form>
                <div class="card-body">
              ...
              <%} else{ %>
                  <label class="col-sm-4">Kayıt Bulunamadı</label>
               <% } } %>
            </div>
            <!-- /.card -->
		<div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="YeniEngelliArac" method="post">
                <div class="card-body">              
                <div class="form-group row">
                 ...
                 <label   class="col-sm-2 col-form-label">Engelli Araç</label>
                    <div class="col-sm-4 input-group">
                      <select class="form-control" name="EngelliArac">
                        <option value="41 P 2110  sürücü: YÜCEL ŞEN Araç kapisi"> 41 P 2110  sürücü: YÜCEL ŞEN Araç kapisi</option>
                        <option value="34 NN 3305 sürücü:MEHMET YILDIZ Araç kapisi">34 NN 3305 sürücü:MEHMET YILDIZ Araç kapisi</option>
                      </select>
                    </div>
                 ...
                 <label   class="col-sm-2 col-form-label">Engelli Açıklama</label>
                    <div class="col-sm-4">
                      <input type="hidden" name="murid" value="<%=Id%>">
          ...
          <div class="col-12">
			                	<div class="table-responsive" style="overflow-x: auto;">
                                  ...
                                  <th>Yönlendirilen Alt Kurum</th>
					                    ...
					                    <tbody>
                                <% for (EngelliAracHizmet engelliAracHizmeti: engelliAracHizmets) { %>
					                    <tr>
					                      <td>
					                      ...
					                      <td><%=engelliAracHizmeti.getEngelliHizmetId()%></td>
                                <td><%=engelliAracHizmeti.getEngelliHizmetTip()%></td>
                                <td><%=engelliAracHizmeti.getEngelliHizmetAltTip()%></td>
					                      <td><%=engelliAracHizmeti.getEngelliAraç()%></td>
					                      <td><%=engelliAracHizmeti.getStatus()%></td>
                                <td><%=engelliAracHizmeti.getRandevuTarih()%></td>
					                      <td><%=engelliAracHizmeti.getHizmetKayitTarih()%></td>
					                    </tr>
                                <% } %>
					                    </tbody>
					                  </table>
