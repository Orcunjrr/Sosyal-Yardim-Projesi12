  ...
  <script>
    $(document).ready(function() {
      ...
      $('#example2 tbody').on('click', '.delete-button', function () {
        var engelliID = $(this).closest('tr').find('td#engelliID').text();

        console.log("Gelen Data  :"+ engelliID);
        selectedId = engelliID;
      ...
      $('#confirmDeleteButton').on('click', function() {
        ...
        $.get("engelliSil", {id:selectedId})
        window.location.href = "engellisil?engelliID=" + selectedId;
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb ">
              ...
              <li class="breadcrumb-item active">Engelli Tip Tanımlama</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <form role="form" action="disabledType" method="post">
                <div class="card-body">
                  <div class="form-group row m-2">
                    <label class="col-sm-2 col-form-label required">Engelli Tip Adı</label>
                    <div class="col-sm-4">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Engelli Tip Listesi</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
                        ...
                        <div class="table-responsive" style="overflow-x: auto;">
                          <table id="example2" class="table table-bordered table-hover" style="width: 100%; table-layout: fixed;">
                            ...
                            <tr>
                              ...
                              <td id="engelliID"><%= disa.getDisabledID() %></td>
                              <td> <%= disa.getDisabledName() %></td>
                              <td><% if(disa.getStatus()==1){%>Aktif<%}else{%>Pasif<% }%></td>
                            </tr>
                            <% } %>
                            </tbody>
                          </table>
