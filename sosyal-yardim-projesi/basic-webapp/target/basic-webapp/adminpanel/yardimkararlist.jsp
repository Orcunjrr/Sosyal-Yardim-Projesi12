  ...
  <script>
    $(document).ready(function() {
      ...
      $('#example2 tbody').on('click', '.delete-button', function () {
        var userId = $(this).closest('tr').find('td#Id').text();
      ...
      $('#confirmDeleteButton').on('click', function() {
        ...
        window.location.href = "SilYardimKarari?Id=" + selectedId;
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                ...
                <% Object mesaj=request.getAttribute("yardimKararList") ; if ( mesaj != null) { %>
                <h2 class="fw-bolder " style="color: cornflowerblue;">
                  <label>Yardım Kararı bulundu!</label>
                </h2>
                <% } %>
              </div>
              <!-- /.card-header -->
              ...
              <form action="yardimkararilisteleme" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <select class="form-control"  name="yardim_tipi">
                        <option value="0">Yardım Seçiniz</option>
                  ...
                  <div class="form-group row ">
                    ...
                    <label class="col-sm-2 col-form-label required">T.C. Kimlik No:</label>
                    <div class="col-sm-4 input-group">
                      <input type="number" class="form-control" name="tcKimlik" maxlength="11" required>
                    </div>
                   ...
                   <div class="col-sm-4">
                     <select class="form-control" name="yardim_alt_tip">
                       <option value="0">Yardım Alt Tip seçiniz</option>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="number" class="form-control" name="soyad">
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-12">
                        ...
                        <div class="table-responsive" style="overflow-x: auto;">
                          <%  Object yokki = request.getAttribute("yardimKararList"); if ( yokki == null) { %>
                          <h2 class="fw-bolder fs-2qx pb-5 pb-md-10" style="color: cornflowerblue;">
                            <label>Yardım Kararı Bulunamadı!</label>
                          </h2>
                          <% } %>
                          <table id="example2" class="table table-bordered table-hover" style="width: 100%; table-layout: fixed;">
                            ...
                            <tr>
                              <td>
                                <a href="YardimKararDuzenle.jsp?ID=<%=yardımBilgi.getKararId()%>">
                              ...
                              <td id="Id"><%=yardımBilgi.getKararId()%> </td>
