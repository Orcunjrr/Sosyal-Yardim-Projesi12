        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb ">
              ...
              <li class="breadcrumb-item active">Yönlendiren Kurum</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <form role="form" method="post" action="YonlendirenKurum">
                <div class="card-body">
                  <div class="form-group row m-2">
                    <label class="col-sm-2 col-form-label required">Yönlendirilen Kurum Adı</label>
                    <div class="col-sm-4">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Yönlendirilen Kurum Bilgileri</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
