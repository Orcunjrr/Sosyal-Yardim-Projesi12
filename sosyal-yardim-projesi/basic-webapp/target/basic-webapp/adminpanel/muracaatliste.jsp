        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <h4 class="fw-bolder " style="color: cornflowerblue;">
              ...
              <form action="SearchServlet" method="post">
                <div class="card-body">
                  <div class="form-group row m-2">
                    ...
                    <div class="col-sm-3">
                      <input type="text" class="form-control" name="muracatno" value="">
                    </div>
                  </div>
                  ...
                  <div class="form-group row m-2">
                    ...
                    <div class="col-sm-3">
                      <select class="form-control" name="mahalle" id="mahalleSelect" onchange="toggleSokakSelect()">
                    ...
                    <div class="col-sm-3">
                      <select class="form-control" name="sokak" id="sokakSelect">
                  ...
                  <div class="form-group row m-2">
                    ...
                    <div class="col-sm-3 input-group">
                      <input type="date" class="form-control" name="dogum_baslangic_tarihi">
                      <div class="input-group-text">-</div>
                      <input type="date" class="form-control" name="dogum_bitis_tarihi">
                    </div>
                        ...
                        <div class="table-responsive" style="overflow-x: auto;">
                          ...
                          <table id="TABLE" class="table table-bordered table-hover" style="width: 100%; table-layout: fixed;">
                            ...
                            <h3 class="fw-bolder fs-2qx pb-5 pb-md-10" style="color: red;">
                              <label>Kullanıcı Bulunamadı!</label>
                            </h3>
                            <% } else{ %>
                            <colgroup>
