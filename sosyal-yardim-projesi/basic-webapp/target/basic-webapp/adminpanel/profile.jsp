          ...
          <div class="col-md-3">
            ...
            <div class="card card-info card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center"><%= info.getAppliName() %>
                </h3>
            ...
            <div class="card card-info card-outline">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Kullanıcı
                    Bilgileri</a></li>
                  <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">İletişim Bilgileri</a>
                  </li>
                  <li class="nav-item"><a class="nav-link" href="#müracaat" data-toggle="tab">Müracaat Bilgileri</a>
                  </li>
                  ...
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        ...
                        <p><%= info.getRegistrationProvince() %>
                        </p>
                      ...
                      <div class="col-sm-3">
                        ...
                        <p><%= info.getRegistrationDistrict() %>
                        </p>
                  ...
                  <div class="tab-pane" id="timeline">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        ...
                        <p><%= info.getContact().getNeighborhood() %>
                        </p>
                      ...
                      <div class="col-sm-3">
                        ...
                        <p><%= info.getContact().getApartment() %>
                        </p>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        ...
                        <p><%= info.getContact().getBlockDoorNo() %>
                        </p>
                      ...
                      <div class="col-sm-3">
                        ...
                        <p><%= info.getContact().getApartmentNo() %>
                        </p>
                      ...
                      <div class="col-sm-3">
                        ...
                        <p><%= info.getContact().getHomePhone() %>
                        </p>
                      ...
                      <div class="col-sm-3">
                        ...
                        <p><%= info.getContact().getCellPhone() %>
                        </p>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        ...
                        <p><%= info.getContact().getAddressDefinition() %>
                        </p>
                      ...
                      <div class="col-sm-3">
                        ...
                        <p><%= info.getAddress().getPublicAddress() %>
                        </p>
                      ...
                      <div class="col-sm-3">
                        ...
                        <p><%= info.getAddress().getAddressNo() %>
                        </p>
                  ...
                  <div class="tab-pane" id="settings">
                    ...
                    <div class="row">
                      <div class="col-sm-3">
                        ...
                        <p><%= info.getPetition().getPetitionReferenceNo() %>
                        </p>
                      </div>
                      <div class="col-sm-3">
                        <label for="müracaat_bilgi2"> İtiraz Dilekçe Referans No</label>
                        <p><%= info.getPetition().getObjectionPetitionRefNo() %>
                        </p>
                      </div>
                      <div class="col-sm-3">
                        <label for="müracaat_bilgi2">Dilekçe Konu</label>
                        <p><%= info.getPetition().getPetitionSubject() %>
                        </p>
                      </div>
                      <div class="col-sm-3">
                        <label for="müracaat_bilgi2">İtiraz Dilekçe Konu</label>
                        <p><%= info.getPetition().getObjectionPetitionSubject() %>
                        </p>
                      </div>
                  ...
                  <div class="tab-pane" id="müracaat">
                    ...
                    <div class="row">
                      <div class="col-sm-3">
                        ...
                        <p><%= info.getApplication().getArchiveFileNo() %>
                        </p>
                      </div>
                      <div class="col-sm-3">
                        <label for="müracaat_bilgi2">Yönlendirilen Tarih</label>
                        <p><%= info.getApplication().getApplicationDate() %>
                        </p>
                      </div>
                      <div class="col-sm-3">
                        <label for="müracaat_bilgi2">Bölge</label>
                        <p><%= info.getApplication().getRegion() %>
                        </p>
                      </div>
                      <div class="col-sm-3">
                        <label for="müracaat_bilgi2">Müracaat Tipi</label>
                        <p><%= info.getApplication().getApplicationType() %>
                        </p>
                      </div>
                      <div class="col-sm-3">
                        <label for="müracaat_bilgi2">Açıklama</label>
                        <p><%= info.getApplication().getDescription() %>
                        </p>
                      </div>
                      <!-- Diğer Müracaat Bilgileri -->
                    </div>
