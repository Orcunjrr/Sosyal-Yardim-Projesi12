...
String roleName = "Role_Tutanak_Ekle";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Müracaat Seçim</h1>
            <ol class="breadcrumb ">
              <li class="breadcrumb-item"><a href="anasayfa.jsp">Anasayfa</a></li>
              <li class="breadcrumb-item"><a href="#">İşlemlerim</a></li>
              <li class="breadcrumb-item"><a href="#">Tutanak</a></li>
              <li class="breadcrumb-item active"> Tutanak Girişi</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <!-- form start -->
              <form role="form" method="post" action="muracaatsecim">
                <div class="card-body">
                  <div class="form-group row m-2">
                    <label class="col-sm-2 col-form-label required">Müracaat yapan kişinin adı</label>
                    <div class="col-sm-4">
                  ...
                  <div class="form-group row m-2">
                    <label class="col-sm-2 col-form-label required">Müracaat yapan kişinin soyadı</label>
                    <div class="col-sm-4">
                  ...
                  <div class="row justify-content-sm-center mt-3 pt-3">
                    <button type="submit" class="btn btn-primary">Devam</button>
                    <a  class="btn btn-white disabled" role="button"></a>
                  ...
                  <div class="col-12">
                    <div class="table-responsive" style="overflow-x: auto;">
                      <table id="example2" class="table table-bordered table-hover" style="width: 100%; table-layout: fixed;">
                        ...
                        <% List<KullaniciBilgi> kulbil = (List<KullaniciBilgi>) request.getAttribute("kisiisim");
                          if (kulbil!= null && !kulbil.isEmpty()) { %>
                        <colgroup>
                        ...
                        <tr>
                          <th></th>
                          <th>Tc Kimlik No</th>
                          <th>Müracaat Yapan Kişi</th>

                        </tr>
                        </tr>
                        </thead>
                        <tbody>
                        <%  for(KullaniciBilgi kur : kulbil){ %>
                        <tr>
                          <td>
                            <a href="MuracatListesic.jsp?Id=<%= kur.getIdInfoId()%>">
                              <i class="fa fa-eye" style="font-size: 20px; color:black; cursor: pointer; vertical-align: middle;"></i>
                            </a>
                          </td>
                          <td><%= kur.getIdNo() %></td>
                          <td><%= kur.getAppliName() %> <%= kur.getSurname() %></td>
