...
String roleName = "Role_Mahalle_Listele";
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#example2 tbody').on('click', '.delete-button', function () {
        ...
        var userId = $(this).closest('tr').find('td#mahalleID').text();
      ...
      $('#confirmDeleteButton').on('click', function() {
        ...
        $.get("mahallesil", {id:selectedId})
        window.location.href = "mahallesil?mahalleID=" + selectedId;
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Mahalle Listele</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
                            ...
                            <tr>
                              <td>
                                <a href="mahalleduzenle.jsp?ID=<%= mahelle.getDistrictID()%>">
                                  <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" class="icon-equal-size">
                                    <style>
                                      .icon-equal-size {
                                        height: 20px;
                                        width: 20px;
                              ...
                              <td id="mahalleID"><%= mahelle.getDistrictID()%></td>
                              <td><%= mahelle.getDistrictName()%></td>
                              <% String bolgeName = mahelle.getBolge().getZoneName();%>
                              <td><%= bolgeName %></td>
                              <td><% if(mahelle.getStatus()==1){%>Aktif<%}else{%>Pasif<% }%></td>
                            </tr>
                            <% } %>
                            </tbody>
                            <% } %>
