  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Yardım Karar Raporu</h1>
            <ol class="breadcrumb ">
              <li class="breadcrumb-item"><a href="#">Anasayfa</a></li>
              <li class="breadcrumb-item"><a href="#">Raporlar</a></li>
              <li class="breadcrumb-item active">Yardım Karar Raporu</li>
            </ol>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="YardımKararRaporu" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4 col-form-label">
                      <label class="form-check-label"><input type="radio" name="itirazDurumu" value="var"> İtiraz Var</label>
                      <label class="form-check-label"><input type="radio" name="itirazDurumu" value="yok"> İtiraz Yok</label>
                    </div>
                  ...
                  <div class="form-group row ">
                    ...
                    <label class="col-sm-2 col-form-label">Oran/Birim:</label>
                    <div class="col-sm-4 input-group">
                      <input type="text" class="form-control" name="">
                    </div>
                  ...
                  <div class="col-12">
                    <div class="table-responsive" style="overflow-x: auto;">
                      <table id="example2" class="table table-bordered table-hover" style="width: 100%; table-layout: fixed;">
                        <%   List<YardimKarari> yardimlist = (List<YardimKarari>) request.getAttribute("YardımKararRaporu");
