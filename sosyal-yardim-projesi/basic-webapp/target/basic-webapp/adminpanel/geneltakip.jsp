...
<%
List<KullaniciBilgi> kid = KullaniciBilgi.getAll();
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb ">
              ...
              <li class="breadcrumb-item active">Genel Takip</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                        ...
                        <div class="table-responsive" style="overflow-x: auto;">
                          <table id="example2" class="table table-bordered table-hover" style="width: 100%; table-layout: fixed;">
                            ...
                            <tr>
                              ...
                              <td><%= k.getApplication().getApplicationDate()%></td>
                            </tr>
                            <% } %>
                            </tbody>
                          </table>
