...
<%
  ...
  YardimTipi yardim = YardimTipi.getbyID(ID);
        ...
        <div class="row mb-2">
          <div class="col-sm-10">
            ...
            <ol class="breadcrumb ">
              ...
              <li class="breadcrumb-item"><a href="#">Yardım Tipi Tanımlama</a></li>
              <li class="breadcrumb-item active">Yardım Tipi Düzenle</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="cekmece" class="form-control" required>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
