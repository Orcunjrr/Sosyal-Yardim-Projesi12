...
<%@ page import="com.example.example.DataBase.Meslek" %>
...
<%
  ...
  Meslek prof =  Meslek.getinfobyProfessionId(Id);


String roleName = "Role_Kullanıcı_Listele";

if (!Personel.RoleUtils.hasRole(userSession, roleName)) {
    response.sendRedirect("../Error/Error.html");
}
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8">
            <h1>Meslek Düzenle</h1>
            <ol class="breadcrumb ">
              <li class="breadcrumb-item"><a href="#">Anasayfa</a></li>
              <li class="breadcrumb-item"><a href="#">Yönetici İşlemleri</a></li>
              <li class="breadcrumb-item"><a href="#">Diğer Tanımlar</a></li>
              <li class="breadcrumb-item"><a href="#">Meslek Tanımlama</a></li>
              <li class="breadcrumb-item active">Meslek Düzenle</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
