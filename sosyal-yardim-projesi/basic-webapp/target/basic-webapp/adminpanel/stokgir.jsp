        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb ">
              ...
              <li class="breadcrumb-item active">Stok Gir</li>
            </ol>
          </div>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Stok Gir</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="StokGiris" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group row m-2">
                    <label   class="col-sm-2 col-form-label required" >Güncel Miktar</label>
                    <div class="col-sm-4">
                      <input class="form-control" type="number" name="guncelMiktar" required>
                    </div>
                  </div>
                  <div class="form-group row m-2">
                    <label   class="col-sm-2 col-form-label required" >Güncel Fiyat</label>
                    <div class="col-sm-4">

                      <input class="form-control" type="number" step="0.01" name="guncelFiyat" required>
                    </div>

                    <label   class="col-sm-2 col-form-label required" >Stok Tanım</label>
                    <div class="col-sm-4">
                      <input class="form-control" type="text" name="stokTanim" required>
                    </div>
                  </div>
