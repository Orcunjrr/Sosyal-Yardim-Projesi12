<%@ page import="com.example.example.DataBase.TutanakDurum" %>
<%@ page import="java.util.ArrayList" %>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
<%List<TutanakDurum> tutanakDurumlar =  TutanakDurum.getAll();%>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tutanak Durum Tanımlama</h1>
            <ol class="breadcrumb ">
              <li class="breadcrumb-item"><a href="#">Anasayfa</a></li>
              <li class="breadcrumb-item"><a href="#">Yönetici İşlemleri</a></li>
              <li class="breadcrumb-item"><a href="#">Diğer Tanımlar</a></li>
              <li class="breadcrumb-item active">Tutanak Durum Tanımlama </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">
                  Durum Tanımlama Bilgileri
                </h3>
              </div>
              <!-- /.card-header -->

              <!-- form başlangıcı -->
              <form action="durumTanimlama" method="post">
                <div class="card-body">
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group text-center">
                      <label class="required">Durum Adı</label>
                      <input type="text" class="form-control" name="DurumAdi" required>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group text-center">
                      <label class="required">Aktif</label>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Durum Tanımlama Bilgileri</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
                  <div class="col-12">
                    <div class="table-responsive" style="overflow-x: auto;">
                      <table id="example2" class="table table-bordered table-hover" style="width: 100%; table-layout: fixed;">
                        ...
                        <tbody>
                        <% for(TutanakDurum durum: tutanakDurumlar ) { %>
                        <tr>
                          <td>
                            <a href="durumtanim.jsp">
                          ...
                          <td><%= durum.getDurumAdi()%></td>
                          <td><%= durum.getAktif() %></td>
                        </tr>
                        <% } %>
                        </tbody>
                      </table>
