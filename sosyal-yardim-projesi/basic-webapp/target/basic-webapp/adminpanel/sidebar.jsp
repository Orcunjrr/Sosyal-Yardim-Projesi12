        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="engelliaraclist.jsp" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="aileyakinlikliste.jsp" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="./durumtanim.jsp" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="./engelligiris.jsp" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Engelli Tanımlama</p>
                    </a>
                  </li>
                  <li class="nav-item">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./tutanakraporsayfasi.jsp" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tutanak Raporu</p>
                </a>
              </li>
