...
<%
  ...
  YakinlikDerecesi akraba = YakinlikDerecesi.getinfobyAffinityId(id);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8">
            <h1>Yakınlık Düzenle</h1>
            <ol class="breadcrumb ">
              <li class="breadcrumb-item"><a href="#">Anasayfa</a></li>
              <li class="breadcrumb-item"><a href="#">Yönetici İşlemleri</a></li>
              <li class="breadcrumb-item"><a href="#">Diğer Tanımlar</a></li>
              <li class="breadcrumb-item"><a href="#">Yakınlık Tanımlama</a></li>
              <li class="breadcrumb-item active">Yakınlık Düzenle</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
