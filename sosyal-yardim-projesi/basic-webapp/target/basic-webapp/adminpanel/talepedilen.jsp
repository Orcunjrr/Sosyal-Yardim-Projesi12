  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8">
            <h1>Talep Edilen Yardım Tipi Tanımlama</h1>
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Talep Edilen Yardım Tipi Tanımlama</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">
                  Talep Edilen Yardım Tipi Tanımlama
                </h3>
              </div>
              <!-- /.card-header -->

              <!-- form start -->
              <form action="TalepYardimTipAdd" method="post">
                <div class="card-body">
                  <div class="form-group row m-2">
                    <label class="col-sm-2 col-form-label required">Yardım Tip Adı</label>
                    <div class="col-sm-4">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Talep Edilen Yardım Listesi</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
