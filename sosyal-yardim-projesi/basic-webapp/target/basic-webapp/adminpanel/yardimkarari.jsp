                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <select class="form-control"  name="yardim_tipi" id="yardimtip_select" onchange="toggleSokakSelect()">
                        <% for(YardimTipi y: yardimtipi){ %>
                        <option id="<%=y.getHelpId()%>" value="<%=y.getHelpId()%>"><%=y.getHelpName()%></option>
                        <%}%>
                      </select>
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <select class="form-control" name="yardim_alt_tip" id="alttip_select">
                        <% for(YardimTipiAlt yarAlt: yardimalttip){ %>
                        <option data-help-id="<%=yarAlt.getHelpId().getHelpId()%>" value="<%=yarAlt.getHelpSubName()%>"><%=yarAlt.getHelpSubName()%></option>
                        <%}%>
                      </select>
                    </div>
                    <script>
                      function toggleSokakSelect() {
                        ...
                        const yardimSelect = document.getElementById('yardimtip_select');
                        const yardimAltSelect = document.getElementById('alttip_select');
                        const yardimSelectId = yardimSelect.value;
                        console.log("Yardım Tip/Grup selected:", yardimSelectId);
                        const altTipOptions = yardimAltSelect.querySelectorAll('option');

                        for (const option of altTipOptions) {
                          console.log("Option dataset.helpId:", option.dataset.helpId);
                          if (option.dataset.helpId == yardimSelectId) {
                            yardimAltSelect.style.display = '';
                    ...
                    <div class="col-sm-4">
                      <input type="number" class="form-control" name="dosya_karar_sayisi">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="date" class="form-control" name="dosya_tarihi" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="date" class="form-control" name="yardim_teslim_tarihi" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row ">
                    ...
                    <div class="col-sm-4">
                      <input type="number" class="form-control" name="yardim_tutari" required>
                    </div>
                  </div>
            ...
            <div class="card card-secondary">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                    <input type="number" class="form-control" name="yardim_kart_no" required>
                    </div>

                    <label  class="col-sm-2 col-form-label required">Karta Yüklenen Miktar:</label>
                    <div class="col-sm-4">
                      <input type="number" class="form-control" name="kart_miktar" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="date" class="form-control" name="yardim_bas_tarihi" required>
                  </div>

                    <label  class="col-sm-2 col-form-label required">Kredi Bitiş Tarihi:</label>
                    <div class="col-sm-4">
                      <input type="date" class="form-control" name="kredi_bitis_tarihi" required>
                    </div>
                  </div>
